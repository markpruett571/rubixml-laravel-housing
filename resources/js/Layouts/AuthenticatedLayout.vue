<!-- https://github.com/inertiajs/pingcrm/blob/master/resources/js/Shared/Layout.vue -->
<template>
        ...
        <div class="md:flex md:flex-col">
            <div class="md:flex md:flex-col md:h-screen">
                <div class="md:flex md:flex-shrink-0">
                    <div class="flex items-center justify-between px-6 py-4 bg-blue-700 md:flex-shrink-0 md:justify-center md:w-56">
                        <Link class="mt-1" href="/">
                            <icon name="office" class="fill-white w-4 h-4" />
                        </Link>
                        <dropdown class="md:hidden" placement="bottom-end">
                            ...
                            <template #dropdown>
                                <div class="mt-2 px-8 py-4 bg-blue-700 rounded shadow-lg">
                                    <main-menu />
                                </div>
                            </template>
                        </dropdown>
                    ...
                    <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
                        <div class="mr-4 mt-1">House Sales App</div>
                        <dropdown class="mt-1" placement="bottom-end">
                            ...
                            <template #dropdown>
                                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                                    <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" :href="`/users/${$page.props.auth.user.id}/edit`">My Profile</Link>
                ...
                <div class="md:flex md:flex-grow md:overflow-hidden">
                    <main-menu class="hidden flex-shrink-0 p-12 w-56 bg-blue-700 overflow-y-auto md:block" />
